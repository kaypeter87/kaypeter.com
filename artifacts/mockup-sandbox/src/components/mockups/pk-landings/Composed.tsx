...
function NightSky({
  ...
  const moonOffX = useTransform(mx, (m) => m * 30);
  const moonOffY = useTransform(my, (m) => m * 30);
  ...
  return (
    ...
    >
      <div 
        ...
        style={{
          background: "linear-gradient(to bottom, #111a2c 0%, #162238 50%, #1b2940 100%)",
        }} 
      />
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 0 100px 30px rgba(240,235,216,0.22), 0 0 250px 80px rgba(240,235,216,0.12)",
          }}
        />
        <div
        ...
        {/* Subtle Halo Ring */}
        <div
          className="absolute inset-[-40%] rounded-full border border-white/5 opacity-40 mix-blend-screen"
        />
        <div
          className="absolute inset-[-80%] rounded-full border border-white/5 opacity-20 mix-blend-screen"
        />
...
export function Composed() {
  ...
  return (
    <div className="relative w-full min-h-[100dvh] overflow-hidden bg-[#0d1321] text-[#f0ebd8] font-serif selection:bg-white/20 selection:text-white">
      {/* Inner-edge vignette */}
      <div className="pointer-events-none absolute inset-0 z-30 shadow-[inset_0_0_120px_rgba(0,0,0,0.5)]" />

      {mounted && <NightSky mx={mx} my={my} />}
      ...
      <div className="absolute inset-0 z-20 flex flex-col justify-between p-8 md:p-12 pointer-events-none">
        ...
        <div className="flex justify-between items-start w-full">
          ...
          <motion.div
            ...
            className="text-[10px] tracking-[0.3em] uppercase font-light text-[#748cab]"
          >
            EST. 2026
          </motion.div>
        </div>
        ...
        <div className="flex flex-col w-full gap-6 pointer-events-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end w-full gap-8">
            ...
            >
              <span className="text-[9px] tracking-[0.25em] uppercase text-[#748cab] font-light">
                Journal &middot; Essays &middot; Field notes
              </span>
              <h1 className="text-lg md:text-xl tracking-[0.1em] font-normal leading-none lowercase text-[#f0ebd8]">
                peter kay
              </h1>
              <p className="mt-1 text-xs tracking-[0.4em] uppercase font-light text-[#748cab]">
                계성우
              </p>
            </motion.div>
            ...
            >
              <span className="text-[9px] tracking-[0.25em] uppercase text-[#748cab] font-light opacity-60">
                Continue
              </span>
              <a
                href="#"
                className="group flex items-center gap-3 text-xs tracking-[0.3em] uppercase transition-colors duration-500 text-[#f0ebd8]"
              >
                <span>Enter</span>
                <span className="w-8 h-[1px] bg-[#748cab] transition-all duration-500 group-hover:w-12 group-hover:bg-[#f0ebd8] origin-left" />
                <span className="text-[#748cab] transition-colors duration-500 group-hover:text-[#f0ebd8]">
                  &rarr;
                </span>
              </a>
            </motion.div>
          ...
          <motion.div 
            ...
            className="w-full h-[1px] bg-[#748cab]/20 origin-left"
          />
